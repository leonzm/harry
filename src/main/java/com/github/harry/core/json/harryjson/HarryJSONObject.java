 ...
 * @Version: 1.0.0
 */
public class HarryJSONObject implements JSONObject {

    private com.github.harry.json.JSONObject jsonObject;

    public HarryJSONObject(com.github.harry.json.JSONObject jsonObject) {
    ...
    public JSONObject getJSONObject(String key) {
        return new HarryJSONObject(jsonObject.getJSONObject(key));
    }

    @Override
    public JSONArray getJSONArray(String key) {
        return new HarryJSONArray(jsonObject.getJSONArray(key));
    }
