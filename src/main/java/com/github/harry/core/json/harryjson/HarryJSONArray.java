 ...
 * @Version: 1.0.0
 */
public class HarryJSONArray implements JSONArray {

    private com.github.harry.json.JSONArray jsonArray;

    public HarryJSONArray(com.github.harry.json.JSONArray jsonArray) {
    ...
    public JSONObject getJSONObject(int index) {
        return new HarryJSONObject(jsonArray.getJSONObject(index));
    }

    @Override
    public JSONArray getJSONArray(int index) {
        return new HarryJSONArray(jsonArray.getJSONArray(index));
    }
